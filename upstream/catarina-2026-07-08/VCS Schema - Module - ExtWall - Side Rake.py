...
# =====================================================
# SIDE RAKE WALL MODULE — PARAMETRIC SCHEMA
# =====================================================

side_rake_wall_module_schema = {
...
def compile_side_rake_wall_module(schema):
...
compile_side_rake_wall_module(side_rake_wall_module_schema)
