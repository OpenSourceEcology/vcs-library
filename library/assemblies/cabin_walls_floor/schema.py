"""CABIN FLOOR + WALLS ASSEMBLY Single-file FreeCAD script Includes: framed floor with top/bottom OSB, standard wall module, window module, single-door module, and cabin assembly compiler."""
